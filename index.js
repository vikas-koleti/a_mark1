...
var q1 = {
  question: "Do you know Vikas?\n 1.yes  2.no\n",
  answer: "1"
}
var q2 = {
  question: "What is Vikas's favorite color?\n 1.blue 2.orange 3.red\n",
  answer: "1"
}
var q4 = {
  question: "What is Vikas's favorite Anime?\n 1.Naruto 2.Death Note 3.Fairy tale\n ",
  answer: "1"
}
var q3 = {
  question: "What is Vikas's favorite fastfood joint? 1.McDonald's 2.Burger king 3.Pizza Hut\n",
  answer: "2"
}
var q5 = {
  question: "Who is Vikas's favorite marvel superhero? 1.Iron Man 2.Doctor Strange 3.Captain America\n",
  answer: "1"
}
...
if (que == "yes" || que == "y") {
  ...
  var ask = readlineSync.question(chalk.blackBright.bold("Do you know Vikas?\n 1.yes 2.no \n"));
  if (ask == "1") {
    quiz();
  }
  else {
    console.log(chalk.yellow.bold("You can't continue\n"));
  }
